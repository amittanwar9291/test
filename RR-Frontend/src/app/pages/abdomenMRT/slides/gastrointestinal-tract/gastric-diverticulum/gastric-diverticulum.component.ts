...
@Component({
  selector: 'rr-gastric-diverticulum',
  templateUrl: './gastric-diverticulum.component.html',
  styleUrls: ['./gastric-diverticulum.component.scss'],
  viewProviders: [{ provide: ControlContainer, useExisting: NgForm }]
})
export class GastricDiverticulumComponent implements OnDestroy {
