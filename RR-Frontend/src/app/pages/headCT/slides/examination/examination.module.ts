...
import { ExaminationIndicationComponent } from './examination-indication/examination-indication.component';
...
@NgModule({
  ...
  declarations: [ExaminationComponent, ExaminationIndicationComponent]
})
