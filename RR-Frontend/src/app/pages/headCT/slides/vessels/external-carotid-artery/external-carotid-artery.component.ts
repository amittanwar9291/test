...
@Component({
  ...
  styleUrls: ['./external-carotid-artery.component.scss'],
  viewProviders: [{ provide: ControlContainer, useExisting: NgForm }]
})
export class ExternalCarotidArteryComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.subscriptions.push(
      ...
      this.translate.stream('headCT.vessels.w016.options').subscribe((out: DropdownModel[]) => (this.w016 = out)),
