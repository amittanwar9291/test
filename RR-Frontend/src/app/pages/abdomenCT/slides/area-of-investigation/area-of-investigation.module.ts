...
import { AreaOfInvestigationComponent } from './area-of-investigation.component';

@NgModule({
  declarations: [AreaOfInvestigationComponent],
  imports: [
    CommonModule,
    FormsModule,
    TranslateModule,
...
export class AreaOfInvestigationModule {}
