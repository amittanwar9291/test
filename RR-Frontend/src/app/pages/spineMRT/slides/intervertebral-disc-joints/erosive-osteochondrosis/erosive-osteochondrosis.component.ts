...
import { ModicClassificationTypesEnum } from '@enums/spineMRT/intervertebral-disc-joints';
...
export class ErosiveOsteochondrosisComponent implements OnInit, OnDestroy {
