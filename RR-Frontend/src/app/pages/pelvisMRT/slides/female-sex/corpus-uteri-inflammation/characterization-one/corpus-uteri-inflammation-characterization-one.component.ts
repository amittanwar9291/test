...
@Component({
  selector: 'rr-corpus-uteri-inflammation-characterization-one',
  templateUrl: './corpus-uteri-inflammation-characterization-one.component.html',
  styleUrls: ['./corpus-uteri-inflammation-characterization-one.component.scss'],
  viewProviders: [{ provide: ControlContainer, useExisting: NgForm }]
})
export class CorpusUteriInflammationCharacterizationOneComponent implements OnInit, OnDestroy {
