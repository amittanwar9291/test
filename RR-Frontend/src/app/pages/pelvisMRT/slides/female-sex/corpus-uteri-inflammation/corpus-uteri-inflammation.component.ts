...
@Component({
  selector: 'rr-corpus-uteri-inflammation',
  templateUrl: './corpus-uteri-inflammation.component.html',
  styleUrls: ['./corpus-uteri-inflammation.component.scss'],
  viewProviders: [{ provide: ControlContainer, useExisting: NgForm }]
})
export class CorpusUteriInflammationComponent implements OnInit, OnDestroy {
