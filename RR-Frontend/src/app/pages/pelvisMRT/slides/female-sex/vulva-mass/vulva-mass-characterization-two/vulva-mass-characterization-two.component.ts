...
@Component({
  selector: 'rr-vulva-mass-characterization-two',
  templateUrl: './vulva-mass-characterization-two.component.html',
  styleUrls: ['./vulva-mass-characterization-two.component.scss'],
  viewProviders: [{ provide: ControlContainer, useExisting: NgForm }]
})
export class VulvaMassCharacterizationTwoComponent implements OnInit, OnDestroy {
