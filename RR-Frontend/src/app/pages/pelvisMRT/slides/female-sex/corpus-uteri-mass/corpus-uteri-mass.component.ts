...
@Component({
  selector: 'rr-corpus-uteri-mass',
  templateUrl: './corpus-uteri-mass.component.html',
  styleUrls: ['./corpus-uteri-mass.component.scss'],
...
export class CorpusUteriMassComponent implements OnInit, OnDestroy {
