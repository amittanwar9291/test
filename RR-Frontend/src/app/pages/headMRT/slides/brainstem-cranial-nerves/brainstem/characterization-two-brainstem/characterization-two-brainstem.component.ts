...
@Component({
  selector: 'rr-characterization-two-brainstem',
  templateUrl: './characterization-two-brainstem.component.html',
  styleUrls: ['./characterization-two-brainstem.component.scss'],
  viewProviders: [{ provide: ControlContainer, useExisting: NgForm }]
})
export class CharacterizationTwoBrainstemComponent {
