...
@Component({
  selector: 'rr-skull-characterization-two',
  templateUrl: './skull-characterization-two.component.html',
  styleUrls: ['./skull-characterization-two.component.scss'],
  viewProviders: [{ provide: ControlContainer, useExisting: NgForm }]
})
export class SkullCharacterizationTwoComponent implements OnDestroy {
