...
@Component({
  selector: 'rr-salivary-glands-charackterization-one',
  templateUrl: './salivary-glands-charackterization-one.component.html',
  styleUrls: ['./salivary-glands-charackterization-one.component.scss'],
  viewProviders: [{ provide: ControlContainer, useExisting: NgForm }]
})
export class SalivaryGlandsCharackterizationOneComponent implements OnDestroy {
