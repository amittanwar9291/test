...
@Component({
  selector: 'rr-paranasal-sinuses-characterization-one',
  templateUrl: './paranasal-sinuses-characterization-one.component.html',
  styleUrls: ['./paranasal-sinuses-characterization-one.component.scss'],
  viewProviders: [{ provide: ControlContainer, useExisting: NgForm }]
})
export class ParanasalSinusesCharacterizationOneComponent implements OnDestroy {
