...
@Component({
  selector: 'rr-skull-base-characterization-one',
  templateUrl: './skull-base-characterization-one.component.html',
  styleUrls: ['./skull-base-characterization-one.component.scss'],
  viewProviders: [{ provide: ControlContainer, useExisting: NgForm }]
})
export class SkullBaseCharacterizationOneComponent implements OnDestroy {
