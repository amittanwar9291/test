...
@Component({
  selector: 'rr-orbita-characterization-one',
  templateUrl: './orbita-characterization-one.component.html',
  styleUrls: ['./orbita-characterization-one.component.scss'],
  viewProviders: [{ provide: ControlContainer, useExisting: NgForm }]
})
export class OrbitaCharacterizationOneComponent implements OnDestroy {
