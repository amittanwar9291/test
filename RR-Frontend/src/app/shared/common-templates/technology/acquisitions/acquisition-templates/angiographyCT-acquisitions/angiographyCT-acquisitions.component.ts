...
@Component({
  selector: 'rr-angiography-ct-acquisition',
  templateUrl: './angiographyCT-acquisitions.component.html',
  styleUrls: ['./angiographyCT-acquisitions.component.scss'],
  viewProviders: [
    {
...
export class AngiographyCTAcquisitionsComponent implements OnInit, OnDestroy {
  ...
  private initTranslations(): void {
    this.subscriptions.push(
      this.translate.stream('shared-templates.technology.angiographyCTInvestigationTechniquesType.options').subscribe(out => {
      ...
      this.translate.stream('shared-templates.technology.reconstructionTypeValues.options').subscribe(out => {
