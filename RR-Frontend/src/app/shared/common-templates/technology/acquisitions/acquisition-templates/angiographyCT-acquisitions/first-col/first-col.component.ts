...
@Component({
  selector: 'rr-angiography-ct-first-col',
...
export class FirstColComponent {
  ...
  resetInvestigationTechniqueDependentControls(value: InvestigationTechniqueTypeEnum): void {
    ...
    if (value === InvestigationTechniqueTypeEnum.DVT) {
      this.model.sliceThicknessInMm = null;
      this.model.tubeVoltage1KV = null;
      this.model.tubeVoltage2KV = null;
      this.model.tubeCurrent1MAs = null;
      this.model.tubeCurrent2MAs = null;
      this.model.tubeCurrentModulationType = TubeCurrentDoseModulationTypeEnum.None;
