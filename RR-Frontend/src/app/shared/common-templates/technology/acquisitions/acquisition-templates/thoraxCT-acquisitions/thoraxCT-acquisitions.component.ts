...
@Component({
  selector: 'rr-thorax-ct-acquisition',
  templateUrl: './thoraxCT-acquisitions.component.html',
  styleUrls: ['./thoraxCT-acquisitions.component.scss'],
  viewProviders: [
    {
...
export class ThoraxCTAcquisitionsComponent implements OnInit, OnDestroy {
  ...
  private initTranslations(): void {
    this.subscriptions.push(
      this.translate.stream('shared-templates.technology.thoraxCTInvestigationTechniquesType.options').subscribe(out => {
