...
@Component({
  selector: 'rr-abdomen-mrt-sequence',
  templateUrl: './abdomenMRT-sequences.component.html',
  styleUrls: ['./abdomenMRT-sequences.component.scss'],
  viewProviders: [
    {
...
export class AbdomenMRTSequencesComponent implements OnInit, OnDestroy {
  ...
  private initTranslations(): void {
    this.subscriptions.push(
      ...
      this.translate.stream('shared-templates.technology.abdomenMRTSequenceTypes.options').subscribe((out: DropdownModel[]) => {
        this.sequenceTypes = Object.values(out);
        this.sequencesService.updateSequenceTypeBits(this.sequenceTypes);
      }),
      this.translate.stream('shared-templates.technology.abdomenMRTOrientationTypes.options').subscribe((out: DropdownModel[]) => {
