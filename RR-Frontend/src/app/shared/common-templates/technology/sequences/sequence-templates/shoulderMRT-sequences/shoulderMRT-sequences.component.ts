...
@Component({
  selector: 'rr-shoulder-mrt-sequence',
  templateUrl: './shoulderMRT-sequences.component.html',
  styleUrls: ['./shoulderMRT-sequences.component.scss'],
  viewProviders: [
    {
...
export class ShoulderMRTSequencesComponent implements OnInit, OnDestroy {
  ...
  private initTranslations(): void {
    this.subscriptions.push(
      ...
      this.translate.stream('shared-templates.technology.shoulderMRTSequenceTypes.options').subscribe((out: DropdownModel[]) => {
        this.sequenceTypes = Object.values(out);
        this.sequencesService.updateSequenceTypeBits(this.sequenceTypes);
      }),
      this.translate.stream('shared-templates.technology.shoulderMRTOrientationTypes.options').subscribe((out: DropdownModel[]) => {
