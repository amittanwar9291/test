...
@Component({
  selector: 'rr-hip-mrt-sequence',
  templateUrl: './hipMRT-sequences.component.html',
  styleUrls: ['./hip-MRT-sequences.component.scss'],
  viewProviders: [
    {
...
export class HipMRTSequencesComponent implements OnInit, OnDestroy {
  ...
  private initTranslations(): void {
    this.subscriptions.push(
      ...
      this.translate.stream('shared-templates.technology.hipMRTSequenceTypes.options').subscribe((out: DropdownModel[]) => {
        this.sequenceTypes = Object.values(out);
        this.sequencesService.updateSequenceTypeBits(this.sequenceTypes);
      }),
      this.translate.stream('shared-templates.technology.hipMRTOrientationTypes.options').subscribe((out: DropdownModel[]) => {
