...
@Component({
  selector: 'rr-feet-mrt-sequence',
  templateUrl: './feetMRT-sequences.component.html',
  styleUrls: ['./feetMRT-sequences.component.scss'],
  viewProviders: [
    {
...
export class FeetMRTSequencesComponent implements OnInit, OnDestroy {
  ...
  private initTranslations(): void {
    this.subscriptions.push(
      ...
      this.translate.stream('shared-templates.technology.feetMRTSequenceTypes.options').subscribe((out: DropdownModel[]) => {
        this.sequenceTypes = Object.values(out);
        this.sequencesService.updateSequenceTypeBits(this.sequenceTypes);
      }),
      this.translate.stream('shared-templates.technology.feetMRTOrientationTypes.options').subscribe((out: DropdownModel[]) => {
