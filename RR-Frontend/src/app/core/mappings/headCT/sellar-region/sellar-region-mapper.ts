...
import { SellarRegionFindingMapper } from '@mappings/headCT/sellar-region/sellar-region-finding.mapper';
...
export class SellarRegionMapper implements IMapper<SellarRegionApiModel, SellarRegionUiModel> {
  constructor(private sellarRegionFindingMapper: SellarRegionFindingMapper) {
    automapper
      .createMap('SellarRegion_HeadCT_UiModel', 'SellarRegion_HeadCT_ApiModel')
    ...
    automapper
      .createMap('SellarRegion_HeadCT_ApiModel', 'SellarRegion_HeadCT_UiModel')
  ...
  mapToAPI(source: SellarRegionUiModel, out: SellarRegionApiModel): SellarRegionApiModel {
    out = automapper.map('SellarRegion_HeadCT_UiModel', 'SellarRegion_HeadCT_ApiModel', source);
  ...
  mapToUI(source: SellarRegionApiModel, out: SellarRegionUiModel): SellarRegionUiModel {
    out = automapper.map('SellarRegion_HeadCT_ApiModel', 'SellarRegion_HeadCT_UiModel', source);
    out.findings.splice(0, out.findings.length);
