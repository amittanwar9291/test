...
export class TechnologyMapper implements IMapper<TechnologyApiModel, TechnologyUiModel> {
  constructor(private sideEffectMapper: SideEffectMapper, private sequenceMapper: SequenceMapper) {
    automapper
      .createMap('Technology_ShoulderMRT_ApiModel', 'Technology_ShoulderMRT_UiModel')
    ...
    automapper
      .createMap('Technology_ShoulderMRT_UiModel', 'Technology_ShoulderMRT_ApiModel')
  ...
  mapToAPI(source: TechnologyUiModel, out: TechnologyApiModel): TechnologyApiModel {
    out = automapper.map('Technology_ShoulderMRT_UiModel', 'Technology_ShoulderMRT_ApiModel', source);
  ...
  mapToUI(source: TechnologyApiModel, out: TechnologyUiModel): TechnologyUiModel {
    out = automapper.map('Technology_ShoulderMRT_ApiModel', 'Technology_ShoulderMRT_UiModel', source);
