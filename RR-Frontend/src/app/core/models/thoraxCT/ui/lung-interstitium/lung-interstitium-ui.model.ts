...
export class LungInterstitiumUiModel extends ReportModelBase {
  ...
  lungsFlapsLocation: LungsFlapsModel;
  ...
  findings: LungInterstitiumFindingUiModel[];
  ...
  constructor() {
    ...
    this.lungsFlapsLocation = new LungsFlapsModel();
    ...
    this.findings = [new LungInterstitiumFindingUiModel()];
