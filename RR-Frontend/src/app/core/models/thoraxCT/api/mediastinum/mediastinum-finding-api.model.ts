...
import { MediastinumFindingBaseApiModel } from '@models/thoraxCT/api/mediastinum/mediastinum-finding-base-api.model';

export class MediastinumFindingApiModel extends MediastinumFindingBaseApiModel {
  // commmon
  isThrombus: boolean;
  isSuspected: boolean;
  ...
  isPleura: boolean;
  isBones: boolean;
  isScaloppingDilutedPedicle: boolean;
  isWidenedNeuroforamen: boolean;
  ...
  constructor() {
    ...
    this.isPleura = false;
    this.isBones = false;
    this.isScaloppingDilutedPedicle = false;
    this.isWidenedNeuroforamen = false;
