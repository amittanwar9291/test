...
export class AortaFindingApiModel extends FindingBase {
  findingType: AortaFindingTypeEnum;
  aortaLocation: string;
  lengthInMm: number;
  ...
  isCoeliacTrunk: boolean; // ang_m_060518
  ...
  constructor() {
    ...
    this.aortaLocationReentry = 'None';
