...
export class SoftTissueFindingUiModel extends SoftTissueFindingBaseUiModel {
  ...
  tendonsLocalization: FootBigTendonsModel;
  isSubordinated: boolean;
  isRetraction: boolean;
  detailMaxDiameterInMm: number;
  differentialDiagnosis1: DifferentialDiagnosisEnum;
  differentialDiagnosis2: DifferentialDiagnosisEnum;
  differentialDiagnosis3: DifferentialDiagnosisEnum;
  ...
  constructor() {
    ...
    this.tendonsLocalization = new FootBigTendonsModel();
    this.isSubordinated = false;
    this.isRetraction = false;
    this.detailMaxDiameterInMm = null;
    this.differentialDiagnosis1 = DifferentialDiagnosisEnum.None;
    this.differentialDiagnosis2 = DifferentialDiagnosisEnum.None;
    this.differentialDiagnosis3 = DifferentialDiagnosisEnum.None;
