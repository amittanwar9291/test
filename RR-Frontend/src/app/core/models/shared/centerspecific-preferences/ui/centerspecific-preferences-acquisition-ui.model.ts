...
export class CenterspecificPreferencesAcquisitionUiModel extends AcquisitionUiBaseModel<CenterspecificPreferencesReconstructionUiModel> {
  ...
  constructor() {
    super(CenterspecificPreferencesReconstructionUiModel);
    ...
    // ThoraxCT and HeadCT specific properties
    this.isPulmonaryArterialPhase = false;

    // AngiographyCT specific properties

    // SpineCT specific properties
