...
export class CartilageLigamentsCapsuleFindingApiModel extends FindingBase {
  findingType: CartilagFindingTypeEnum;

  // Common
  cartilageLocation: string;
  sizeInMm: number;
  ...
  isIntraosseousCystsBesideTheLesion: boolean;
  ...
  constructor() {
    ...
    this.isIntraosseousCystsBesideTheLesion = false;
