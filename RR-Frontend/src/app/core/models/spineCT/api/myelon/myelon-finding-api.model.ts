...
export class MyelonFindingApiModel extends FindingBase {
  ...
  localizationTopOrBottomVertebra: string;
  ...
  localizationOfNerveRootDisplacement: string;

  localizationOfNeuralForaminalWidening: string;
  ...
  differentialDiagnosisAbove1LesionLocations: string;
  ...
  constructor() {
    ...
    this.localizationTopOrBottomVertebra = 'None';
    ...
    this.localizationOfNerveRootDisplacement = 'None';
    this.localizationOfNeuralForaminalWidening = 'None';
    ...
    this.differentialDiagnosisAbove1LesionLocations = 'None';
  }
}
