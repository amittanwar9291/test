...
import { SoftTissuesFindingBaseApiModel } from '@models/spineCT/api/soft-tissues/soft-tissues-finding-base-api.model';

export class SoftTissuesFindingApiModel extends SoftTissuesFindingBaseApiModel {
  // Common
  ...
  isMuscle: boolean;
  isNerveRoot: boolean;
  spineLocationBones: string; /// SpineDirectionalLocation
  isUrether: boolean;
  ...
  moreThanOneLesionSpineLocation: string; /// spineLocaltion
  ...
  constructor() {
    ...
    this.moreThanOneLesionSpineLocation = 'None';
