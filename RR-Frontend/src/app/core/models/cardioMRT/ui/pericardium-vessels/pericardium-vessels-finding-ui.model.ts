...
export class PericardiumVesselsFindingUiModel extends FindingBase {
  ...
  lungLocalizer: LungLocalizerUiModel;
  ...
  constructor() {
    ...
    this.lungLocalizer = new LungLocalizerUiModel();
