...
export class MaleSexFindingBaseApiModel extends FindingBase {
  // Common
  findingType: string;
  ...
  // PenisMass
  signalT1wSliderType: string;
  signalT2wSliderType: string;
  ...
  scrotumMassSignalT1wSliderType: string;
  scrotumMassSignalT2wSliderType: string;
  ...
  constructor() {
    ...
    // PenisMass
    this.signalT1wSliderType = 'None';
    this.signalT2wSliderType = 'None';
    ...
    this.scrotumMassSignalT1wSliderType = 'None';
    this.scrotumMassSignalT2wSliderType = 'None';
