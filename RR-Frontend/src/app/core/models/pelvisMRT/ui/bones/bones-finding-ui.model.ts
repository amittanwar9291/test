import { BonesFindingBaseUiModel } from '@models/pelvisMRT/ui/bones/bones-finding-base-ui.model';
...
export class BonesFindingUiModel extends BonesFindingBaseUiModel {
  ...
  expansionHipLocalizer: HipBones;
  isOsSacrum: boolean;
  ...
  singleSelectionTumorHipLocalizer: HipBones;
  ...
  constructor() {
    ...
    this.hipLocalizer = new HipBones();
    ...
    this.expansionHipLocalizer = new HipBones();
    ...
    this.singleSelectionTumorHipLocalizer = new HipBones();
