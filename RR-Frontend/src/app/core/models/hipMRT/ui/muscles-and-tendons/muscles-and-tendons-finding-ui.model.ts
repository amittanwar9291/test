...
export class MusclesAndTendonsFindingUiModel extends FindingBase {
  // Common
  ...
  t1wSignalCharacteristics: number;
  t2wSignalCharacteristics: number;
  ...
  constructor() {
    ...
    this.t1wSignalCharacteristics = 0;
    this.t2wSignalCharacteristics = 0;
