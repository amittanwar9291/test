...
import {
  ...
  PeriodTypeEnum,
  RegressiveTypeEnum,
  SummaryDiagnosisTypeEnum,
  SummaryFindingTypeEnum
} from '@enums/headMRT/summary/';
...
export class SummaryFindingUiModel extends FindingBase {
  ...
  progressControlDate: MonthYearModel;
  ...
  constructor() {
    ...
    this.progressControlDate = new MonthYearModel();
