...
export class VesselsFindingUiModel extends FindingBase {
  ...
  vascularTerritoryLocations: ArterialTerritoriesLocalizerModel;
  ...
  cerebralVenousThrombosisLocations: CerebralVenousThrombosisLocalizerModel;
  ...
  isV3: boolean;
  isV4: boolean;
  segmentsBouthillierLocations: CarotidArteryUiModel;
  ...
  constructor() {
    ...
    this.vascularTerritoryLocations = new ArterialTerritoriesLocalizerModel();
    ...
    this.cerebralVenousThrombosisLocations = new CerebralVenousThrombosisLocalizerModel();
    ...
    this.isV3 = false;
    this.isV4 = false;
    this.segmentsBouthillierLocations = new CarotidArteryUiModel();
