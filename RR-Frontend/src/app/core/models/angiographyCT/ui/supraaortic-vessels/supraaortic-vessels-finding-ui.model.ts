...
export class SupraaorticVesselsFindingUiModel extends FindingBase {
  ...
  internalCarotidArterySegmentsLocation: CarotidArteryUiModel;
  ...
  constructor() {
    ...
    // region InternalCarotidArtery
    this.internalCarotidArterySegmentsLocation = new CarotidArteryUiModel();
