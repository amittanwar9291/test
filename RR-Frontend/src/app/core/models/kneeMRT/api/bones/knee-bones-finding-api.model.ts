...
export class KneeBonesFindingApiModel extends FindingBase {
  findingType: BonesFindingTypeEnum;

  // Common
  kneeLocation: string;
  kneeExtensionLocation: string;
  ...
  isDifferentialDiagnosisSubordinate: false;
  ...
  isCorticalDesmoidHeterogeneous: false;
  ...
  constructor() {
    ...
    this.kneeExtensionLocation = 'None';
    ...
    this.lateralImpressionFractureDepthInMm = 0;
    ...
    this.obliqueImpressionFractureDepthInMm = 0;
    ...
    this.subperiostealAbscessDiameter = 0;
