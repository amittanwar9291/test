...
export class RibbonsFindingApiModel extends FindingBase {
  findingType: RibbonsFindingTypeEnum;

  // common
  meniscusLocalization1: string;
  ...
  constructor() {
    ...
    // common
    this.meniscusLocalization1 = 'None';
    ...
    this.meniscusLocalization2 = 'None';
