...
import { MusculatureApiModel } from './musculature-api.model';
...
export class SoftPartsFindingApiModel extends FindingBase {
  findingType: SoftPartsFindingTypeEnum;

  musculatureFindings: MusculatureApiModel[];
  ...
  constructor() {
    ...
    this.musculatureFindings = [new MusculatureApiModel()];
