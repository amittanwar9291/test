...
export class VesselsFindingApiModel extends FindingBase {
  ...
  cortexLocation: string; // rr-cortex-localizer-complex
  ...
  basalGangliaLocation: string; // rr-basal-ganglia-locations-simple
  ...
  vascularTerritoryLocation: string; // rr-arterial-territories-localizer-simple
  ...
  affectedSegmentsOrVesselsLocation: string; // rr-arteries-segments-small-localizer
  ...
  internalCarotidArterySegmentsLocations: string; // rr-carotid-artery-small-localizer
  ...
  cerebralVenousThrombosisLocation: string; // rr-cerebral-venous-thrombosis-localizer-simple
  ...
  imageFileId: string;
  imageFile: FileApiModel; // referencePicture: ReferencePictureUiModel;

  perfusion01SerialNumber: string;
  perfusion01PictureNumber: string;
  perfusion01ImageFileId: string;
  perfusion01ImageFile: FileApiModel;

  perfusion02SerialNumber: string;
  perfusion02PictureNumber: string;
  perfusion02ImageFileId: string;
  perfusion02ImageFile: FileApiModel;
  ...
  constructor() {
    ...
    this.basalGangliaLocation = 'None';
    ...
    this.vascularTerritoryLocation = 'None';
    ...
    this.internalCarotidArterySegmentsLocations = 'None';
    ...
    this.cerebralVenousThrombosisLocation = 'None';
    ...
    this.perfusion01SerialNumber = '';
    this.perfusion01PictureNumber = '';
    this.perfusion01ImageFileId = null;
    this.perfusion01ImageFile = null;

    this.perfusion02SerialNumber = '';
    this.perfusion02PictureNumber = '';
    this.perfusion02ImageFileId = null;
    this.perfusion02ImageFile = null;
  }
}
