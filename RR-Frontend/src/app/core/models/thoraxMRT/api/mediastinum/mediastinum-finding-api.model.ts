...
export class MediastinumFindingApiModel extends FindingBase {
  ...
  focalSignalVoidType: FocalSignalVoidTypeEnum;
  ...
  constructor() {
    ...
    this.focalSignalVoidType = FocalSignalVoidTypeEnum.None;
