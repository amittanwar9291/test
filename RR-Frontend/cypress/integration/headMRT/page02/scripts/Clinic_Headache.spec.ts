...
context('Page 2 - headMRT', () => {
  ...
  describe('Clinic_Headache', () => {
    it('Clinic_Headache', () => {
      findingColumn.selectFindingOptionByAppearance(0);
      elementShouldBeEnabled('hea_m_020106');

      elementShouldBeEnabled('hea_m_020203');
      elementShouldBeEnabled('hea_m_020204');
      elementShouldBeEnabled('hea_m_020206');
      elementShouldBeEnabled('hea_m_020207');
    });
  });
});
