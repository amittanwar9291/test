...
context('Page 2 - headMRT', () => {
  ...
  describe('Clinic_Dysesthesia', () => {
    it('Clinic_Dysesthesia', () => {
      findingColumn.selectFindingOptionByAppearance(9);
      elementShouldBeEnabled('hea_m_020106');

      elementShouldBeEnabled('hea_m_020266');
      elementShouldBeEnabled('hea_m_020267');
      elementShouldBeEnabled('hea_m_020268');
    });
  });
});
