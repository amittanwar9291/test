...
context('Page 2 - headMRT', () => {
  ...
  describe('Clinic_Cognitive changes', () => {
    it('Clinic_Cognitive changes', () => {
      findingColumn.selectFindingOptionByAppearance(11);
      elementShouldBeEnabled('hea_m_020106');

      elementShouldBeEnabled('hea_m_020223');
      elementShouldBeEnabled('hea_m_020224');
      elementShouldBeEnabled('hea_m_020225');
      elementShouldBeEnabled('hea_m_020225');
    });
  });
});
