...
context('Page 06 - headMRT', () => {
  ...
  it('Focal DD I know DD2 (Fazekas) DD3 (Who)', () => {
    // Enabled options
    ...
    // elementShouldBeDisabled('hea_m_060251'); TODO - DUPLICATE ID - at Localization tab and DD tab
    // elementShouldBeDisabled('hea_m_060253'); TODO - DUPLICATE ID - at Localization tab and DD tab
