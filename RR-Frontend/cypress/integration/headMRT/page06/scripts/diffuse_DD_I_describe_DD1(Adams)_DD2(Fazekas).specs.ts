...
context('Page 06 - headMRT', () => {
  ...
  it('Diffuse DD I describe DD1 (Adams) DD2 (Fazekas)', () => {
    // Enabled options
    ...
    // TODO - should be changed to ID for 'I describe' when added to the source code - 22352
    ...
    selectDropdownOptionOS('hea_m_060248', 30, true, true);
    ...
    selectDropdownOptionOS('hea_m_060341', 13, true, true);
