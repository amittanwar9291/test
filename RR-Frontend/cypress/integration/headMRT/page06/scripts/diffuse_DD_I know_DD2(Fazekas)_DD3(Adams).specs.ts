...
context('Page 06 - headMRT', () => {
  ...
  it('Diffuse DD I know DD2 (Fazekas) DD3 (Adams)', () => {
    // Enabled options
    ...
    selectDropdownOptionOS('hea_m_060341', 13, true, true); // TODO - wrong ID at 'DD2' - correct ID -> hea_m_060377 - bug 22698
    elementShouldBeEnabled('hea_m_060344'); // Fazekas
    elementShouldBeEnabled('hea_m_060439'); // TODO - wrong ID at 'DD3' - correct ID -> hea_m_060473 - bug 22698

    // Select 'Diffuse axonal injury' from 'Differential diagnosis 3'
    selectDropdownOptionOS('hea_m_060439', 30, true, true); // TODO - wrong ID at 'DD3' - correct ID -> hea_m_060473 - bug 22698
    // TODO - wrong ID at 'Adams' - correct ID -> hea_m_060475 - bug 22711
    // TODO - DUPLICATE ID with the same DD at Localization tab - cannot execute
    // elementShouldBeEnabled('hea_m_060379'); // TODO - wrong ID - correct ID: hea_m_060475 - bug 22711 (cannot be execute as current ID is the same as the same DD below DD2)
