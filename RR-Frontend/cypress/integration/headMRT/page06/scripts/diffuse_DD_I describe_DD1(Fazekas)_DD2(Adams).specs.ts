...
context('Page 06 - headMRT', () => {
  ...
  it('Diffuse DD I describe DD1 (Fazekas) DD2 (Adams)', () => {
    // Enabled options
    ...
    elementShouldBeEnabled('hea_m_060528'); // TODO - - DUPLICATE ID - at Localzation tab and DD tab

    // Select 'Microangiopathy' from 'Differential diagnosis 1'
    // TODO - wrong ID at 'DD1*' - correct ID -> hea_m_060286 - bug 22692
    selectDropdownOptionOS('hea_m_060248', 13, true, true);
    elementShouldBeEnabled('hea_m_060249');
    // elementShouldBeEnabled('hea_m_060251'); // TODO - DUPLICATE ID - at Localzation tab and DD tab
    ...
    selectDropdownOptionOS('hea_m_060341', 30, true, true);
    elementShouldBeEnabled('hea_m_060342');
    elementShouldBeEnabled('hea_m_060379');
