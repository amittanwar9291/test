...
context('Page 06 - headMRT', () => {
  ...
  it('Diffuse Localization I describe', () => {
    ...
    elementShouldBeEnabled('hea_m_060205');
    elementShouldBeEnabled('hea_m_060288');
    ...
    // Cortex
    clickElement('hea_m0605201', true, 'checkbox'); // TODO - wrong ID - change ID to correct one: hea_m_0605201 - bug 22606
    cy.byRRID('hea_m0605201')
      .shadowFind('div')
      .should('have.class', 'ui-state-active'); // TODO - wrong ID - change ID to correct one: hea_m_0605201 - bug 22606
