...
context('Page 06 - headMRT', () => {
  ...
  it('Focal DD I know DD1 (WHO)', () => {
    ...
    // Select Glioma from DD1
    selectDropdownOptionOS('hea_m_060204', 4, false, true);
    cy.get('p-dropdown')
      .find('span')
      .contains('Glioma');
    elementShouldBeEnabled('hea_m_060205');
    ...
    // elementShouldBeDisabled('hea_m_060253'); // TODO - DUPLICATE ID at Localization and DD tabs
