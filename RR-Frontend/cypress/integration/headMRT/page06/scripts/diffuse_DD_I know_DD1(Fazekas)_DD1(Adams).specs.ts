...
context('Page 06 - headMRT', () => {
  ...
  it('Diffuse DD I know DD1 (Fazekas) DD1 (Adams)', () => {
    // Enabled options
    ...
    selectDropdownOptionOS('hea_m_060204', 13, true, true);
    elementShouldBeEnabled('hea_m_060205');

    // Select 'Diffuse axonal injury' from 'Differential diagnosis 1'
    // TODO - wrong ID at DD1* Localization - correct -> hea_m_060254 - bug 22704
    selectDropdownOptionOS('hea_m_060204', 30, true, true);
    elementShouldBeEnabled('hea_m_060205');
    // elementShouldBeEnabled('hea_m_060288'); // TODO - DUPLICATE ID with the same DD at Localization tab
    ...
    elementShouldBeDisabled('hea_m_060288');
    ...
    // Select 'Vasculitis' from 'Differential diagnosis 2'
    selectDropdownOptionOS('hea_m_060341', 15, true, true); // TODO - wrong ID at 'DD2' - correct ID -> hea_m_060377 - bug 22698
