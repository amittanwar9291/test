...
context('Page 04 - HeadMRT', () => {
  ...
  it('Aneurysm_Circle of Willis & cerebral arteries', () => {
    // CE Yes
    ...
    clickElement('hea_m_040256', true, 'radio');
    elementShouldBeEnabled('hea_m_040354');
    ...
    // Click localizer
    clickElement('hea_m_040354', true);
    cy.get('.large-localizer')
      .shadowFind('tspan')
      .contains(' ACA – A1 ')
      .click();
    cy.get('.large-localizer')
    ...
    cy.get('.large-localizer')
      .shadowFind('text')
      .contains(' ACA – A1 ')
      .should('not.have.class', 'text-selected');
    cy.get('.large-localizer')
    ...
    checkInputFieldValue('hea_m_040459', 60);
