...
context('Page 08 - HeadMRT', () => {
  ...
  it('Brainstem Localization - I know', () => {
    // Page 8
    ...
    elementShouldBeEnabled('hea_m_080256');
    ...
    elementShouldBeEnabled('hea_m_080250');
    clickElement('hea_m_080250', true, 'checkbox');
    elementShouldHaveGivenState('true', 'hea_m_080250');
    elementShouldBeEnabled('hea_m_080251');
    elementShouldBeEnabled('hea_m_080252');
    clickElement('hea_m_080251', true, 'radio');
    elementShouldHaveGivenState('true', 'hea_m_080251');
    clickElement('hea_m_080252', true, 'radio');
    elementShouldHaveGivenState('true', 'hea_m_080252');
