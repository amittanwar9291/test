...
context('Page 08 - HeadMRT', () => {
  ...
  it('Cranial nerves Localization - I know', () => {
    // Page 8
    ...
    // Select I know radio button
    /*clickElement('hea_m_080113', true, 'radio');
    elementShouldHaveGivenState('true', 'hea_m_080113');*/
    ...
    elementShouldBeEnabled('hea_m_080204');
    ...
    selectDropdownOptionOS('hea_m_080204', '2', true, true);
    elementShouldBeEnabled('hea_m_080253');
    clickElement('hea_m_080253', true, 'checkbox');
    elementShouldHaveGivenState('true', 'hea_m_080253');
    elementShouldBeEnabled('hea_m_080254');
    elementShouldBeEnabled('hea_m_080255');
    clickElement('hea_m_080254', true, 'radio');
    elementShouldHaveGivenState('true', 'hea_m_080254');
    clickElement('hea_m_080255', true, 'radio');
    elementShouldHaveGivenState('true', 'hea_m_080255');

    // Check Side radio buttons
