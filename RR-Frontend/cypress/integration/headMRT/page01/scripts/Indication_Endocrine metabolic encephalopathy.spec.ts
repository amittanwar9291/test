...
context('Page 1 - headMRT', () => {
  ...
  describe('Indication_Endocrine metabolic encephalopathy', () => {
    it('Indication_Endocrine metabolic encephalopathy', () => {
      ...
      selectDropdownOptionOS('hea_m_010402-1', 11, true, true);
