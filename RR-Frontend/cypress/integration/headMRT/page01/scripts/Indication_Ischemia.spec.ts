...
context('Page 1 - headMRT', () => {
  ...
  describe('Indication_Ischemia', () => {
    it('Indication_Ischemia', () => {
      ...
      selectDropdownOptionOS('hea_m_010402-1', 0, true, true);
      elementShouldBeEnabled('hea_m_010502');
      elementShouldBeEnabled('hea_m_010503');
      elementShouldBeEnabled('hea_m_010504');

      elementShouldBeEnabled('hea_m_010506');
      elementShouldBeEnabled('hea_m_010507');
    });
  });
});
