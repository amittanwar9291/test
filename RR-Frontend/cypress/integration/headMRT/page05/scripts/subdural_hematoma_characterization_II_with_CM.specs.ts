...
context('Page 05 - headMRT', () => {
  ...
  it('Subdural hematoma Characterization II with CM', () => {
    // Go to Page 3
    ...
    elementShouldBeEnabled('hea_m_050285');
    clickElement('hea_m_050285', true, 'checkbox');
    ...
    elementShouldBeEnabled('hea_m_050361');

    clickElement('hea_m_050361', true, 'checkbox');
    ...
    selectDropdownOptionOS('hea_m_050371', 2, true, true);
