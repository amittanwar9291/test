...
context('Page 11 - HeadMRT', () => {
  ...
  it('Base of Skull Localization describe', () => {
    ...
    elementShouldBeEnabled('hea_m_110266');
    elementShouldBeEnabled('hea_m_110273');

    // Choose any diagnosis from first dropdown
    selectDropdownOptionOS('hea_m_110266', 2, true, true);
    elementShouldBeEnabled('hea_m_110267');
    elementShouldBeEnabled('hea_m_110269');

    clickElement('hea_m_110267', true, 'checkbox');
    elementShouldBeChecked('hea_m_110267');
