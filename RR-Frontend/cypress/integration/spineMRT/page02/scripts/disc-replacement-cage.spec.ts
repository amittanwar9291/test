...
context('SpineMRT - page02', () => {
  ...
  describe('Disc replacement', () => {
    it('Selecting Cage', () => {
      ...
      cy.shadowRRIdFind('rr-spine-complex', 'spi_m_010104-C2d').shadowClick();
      cy.shadowRRIdFind('rr-spine-complex', 'spi_m_010104-C4d').shadowClick();
      cy.shadowRRIdFind('rr-spine-complex', 'spi_m_0201501').shadowClick();
    });
  });
});
