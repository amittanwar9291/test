...
context('Page 06 - SpineMRT', () => {
  ...
  it('Focal tumor_I describe_Differentialdiagnose.spec', () => {
    ...
    selectFindingsDropdownOption('spi_m_060226', '.ui-dropdown-label', 1, true, true);
    elementShouldBeEnabled('spi_m_060228');

    selectFindingsDropdownOption('spi_m_060228', '.ui-dropdown-label', 1, true, true);
