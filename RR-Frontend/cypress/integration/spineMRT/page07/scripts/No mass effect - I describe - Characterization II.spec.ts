...
context('Page 07 - SpineMRT', () => {
  ...
  it('No mass effect - I describe - Characterization II.spec', () => {
    ...
    elementShouldBeEnabled('spi_m_0704509');
    ...
    selectDropdownOption('spi_m_0704509', 3);
    elementShouldBeEnabled('spi_m_0704510');

    selectDropdownOption('spi_m_0704510', 3);
    elementShouldBeEnabled('spi_m_070479');

    elementShouldBeEnabled('spi_m_070479');
    elementShouldBeEnabled('spi_m_0704511');
