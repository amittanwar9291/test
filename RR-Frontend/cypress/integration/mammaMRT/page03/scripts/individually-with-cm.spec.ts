...
context('page03 - Individually with cm', () => {
  ...
  describe('Sequences', () => {
    it('Individually with CM -> Yes', () => {
      ...
      selectFindingsDropdownOption('uni_x_030210-1', '.ui-dropdown-label', 2, true, true);
      ...
      elementShouldBeEnabled('uni_x_030414');
      elementShouldBeEnabled('uni_x_030415');
      elementShouldBeEnabled('uni_x_030420');
    });
  });
});
