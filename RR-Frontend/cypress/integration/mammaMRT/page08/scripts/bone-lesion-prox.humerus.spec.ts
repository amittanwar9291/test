...
context('Page 08 - Bone Lesion Prox', () => {
  ...
  describe('Bone Lesion -> Prox. Humerus', () => {
    it('select Bone Lesion -> Prox. Humerus', () => {
      clickElement('mam_m_080105', true, 'radio');
      elementShouldBeEnabled('mam_m_080106-1');
      selectFindingsDropdownOption('mam_m_080106-1', '.ui-dropdown-label', 0, true, true);
      ...
      clickElement('mam_m_080203', true, 'radio');
      cy.byRRID('mam_m_080205').type('60');
