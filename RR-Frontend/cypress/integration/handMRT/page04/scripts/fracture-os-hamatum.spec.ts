...
context('Page 04 - HandMRT', () => {
  ...
  it('Fracture os hamatum', () => {
    ...
    elementShouldBeEnabled('han_m_040358');
    elementShouldBeEnabled('han_m_040359');
    elementShouldBeEnabled('han_m_040360');
    elementShouldBeEnabled('han_m_0403215');

    clickElement('han_m_0403215', true, 'radio');
