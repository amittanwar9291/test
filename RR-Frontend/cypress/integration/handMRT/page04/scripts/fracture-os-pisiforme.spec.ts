...
context('Page 04 - HandMRT', () => {
  ...
  it('Fracture os pisiforme', () => {
    ...
    elementShouldBeEnabled('han_m_040364');
    elementShouldBeEnabled('han_m_040365');
    elementShouldBeEnabled('han_m_040366');
    elementShouldBeEnabled('han_m_0403221');

    clickElement('han_m_0403221', true, 'radio');
