...
context('Page 04 - HandMRT', () => {
  ...
  it('Fracture os scaphoideum', () => {
    ...
    elementShouldBeEnabled('han_m_040350');
    elementShouldBeEnabled('han_m_040351');
    elementShouldBeEnabled('han_m_040352');
    elementShouldBeEnabled('han_m_040353');

    clickElement('han_m_040351', true, 'radio');
    elementShouldBeEnabled('han_m_040435');
    elementShouldBeEnabled('han_m_040436');
    elementShouldBeEnabled('han_m_040437');

    clickElement('han_m_040352', true, 'radio');
    elementShouldBeEnabled('han_m_040435');
    elementShouldBeEnabled('han_m_040436');
    elementShouldBeEnabled('han_m_040437');

    clickElement('han_m_040353', true, 'radio');
