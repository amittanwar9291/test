...
context('Page 04 - HandMRT', () => {
  ...
  it('Osteoarthrosis_CMC D1', () => {
    ...
    elementShouldBeEnabled('han_m_040573');
    elementShouldBeEnabled('han_m_040574');
    elementShouldBeEnabled('han_m_040575');
    elementShouldBeEnabled('han_m_040572');
  });
});
