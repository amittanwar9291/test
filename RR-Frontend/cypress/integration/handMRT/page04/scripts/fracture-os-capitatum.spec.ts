...
context('Page 04 - HandMRT', () => {
  ...
  it('Fracture os capitatum', () => {
    ...
    elementShouldBeEnabled('han_m_040355');
    elementShouldBeEnabled('han_m_040356');
    elementShouldBeEnabled('han_m_040357');
    elementShouldBeEnabled('han_m_0403212');

    clickElement('han_m_0403212', true, 'radio');
