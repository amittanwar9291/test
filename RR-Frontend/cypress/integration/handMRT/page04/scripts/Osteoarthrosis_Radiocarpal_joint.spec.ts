...
context('Page 04 - HandMRT', () => {
  ...
  it('Osteoarthrosis_radiocarpal joint', () => {
    ...
    elementShouldBeEnabled('han_m_040461');
    elementShouldBeEnabled('han_m_040462');
    elementShouldBeEnabled('han_m_040463');
    elementShouldBeEnabled('han_m_040464');

    elementShouldBeEnabled('han_m_0404109');
  });
});
