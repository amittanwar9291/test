...
context('Page 04 - HandMRT', () => {
  ...
  it('Fracture os lunatum', () => {
    ...
    elementShouldBeEnabled('han_m_040345');
    elementShouldBeEnabled('han_m_040346');
    elementShouldBeEnabled('han_m_040347');
    elementShouldBeEnabled('han_m_040348');

    clickElement('han_m_040348', true, 'radio');
