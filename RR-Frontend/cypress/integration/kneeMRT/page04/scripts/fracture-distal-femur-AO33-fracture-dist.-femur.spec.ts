...
context('Page 04 - Bones', () => {
  ...
  describe('Fracture – Distal Femur AO33', () => {
    it('Fracture – Distal Femur AO33 -> Fracture dist. Femur not specified', () => {
      clickElement('kne_m_040105', true, 'radio');
      elementShouldBeEnabled('kne_m_040106-1');
      findingColumn.selectFindingOptionByAppearance(0);
      clickElement('kne_m_040208', true, 'radio');
      elementShouldBeEnabled('kne_m_040210');
      elementShouldBeEnabled('kne_m_040211');
    });
  });
});
