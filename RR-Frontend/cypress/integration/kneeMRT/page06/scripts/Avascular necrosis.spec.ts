...
context('Page 05 - Anterior cruciate ligament (ACL).spec', () => {
  ...
  it('Avascular necrosis', () => {
    ...
    elementShouldBeEnabled('kne_m_060350');
    elementShouldBeEnabled('kne_m_060351');
    elementShouldBeEnabled('kne_m_060353');
    elementShouldBeEnabled('kne_m_060355');

    elementShouldBeEnabled('kne_m_060441');
    elementShouldBeEnabled('kne_m_060442');
    ...
    elementShouldBeEnabled('kne_m_060203');
    cy.byRRID('kne_m_060351').click();
    cy.byRRID('kne_m_060442').click();
    elementShouldBeEnabled('kne_m_060352');
    elementShouldBeEnabled('kne_m_060443');
    elementShouldBeEnabled('kne_m_060445');
  });
});
