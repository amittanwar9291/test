...
context('Page 08 - Soft parts', () => {
  ...
  it('Bursitis - Two or more Localizations selected', () => {
    ...
    clickElement('kne_m_080234');
    elementShouldBeDisabled('kne_m_080330');
    elementShouldBeDisabled('kne_m_080331');
    elementShouldBeDisabled('kne_m_080333');
    elementShouldBeDisabled('kne_m_0803300');
  });
});
