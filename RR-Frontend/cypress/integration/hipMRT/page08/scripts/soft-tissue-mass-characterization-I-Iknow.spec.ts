...
context('Page 08 - Soft tissue', () => {
  ...
  describe('Soft tissue', () => {
    it('Soft tissue -> Soft Tissue Mass -> Characterization -> I know', () => {
      ...
      elementShouldBeEnabled('hip_m_080215');
      ...
      selectFindingsDropdownOption('hip_m_080215', '.ui-dropdown-label', 2, true, true);
      elementShouldBeEnabled('hip_m_080216');

      clickElement('hip_m_080216', true, 'checkbox');
      elementShouldBeEnabled('hip_m_080217');
      elementShouldBeEnabled('hip_m_080218');
