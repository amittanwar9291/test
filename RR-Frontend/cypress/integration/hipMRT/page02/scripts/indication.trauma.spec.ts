...
context('Hip page02 - Indication - Trauma', () => {
  ...
  describe('Indication - Trauma', () => {
    it('Trauma', () => {
      findingColumn.selectFindingOptionByName('Trauma');
      ...
      elementShouldBeEnabled('hip_m_020215');
      elementShouldBeEnabled('hip_m_020216');
    });
  });
});
