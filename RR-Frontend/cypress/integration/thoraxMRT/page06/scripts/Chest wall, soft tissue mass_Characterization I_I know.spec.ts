...
context('Page 06 - Thoracic MRT', () => {
  ...
  it('Chest wall, soft tissue mass_Characterization I_I know', () => {
    ...
    elementShouldBeEnabled('tho_m_060251');

    selectDropdownOptionOS('tho_m_060251', 3, true, true);

    clickElement('tho_m_060252', true, 'checkbox');
    elementShouldBeEnabled('tho_m_060253');
    elementShouldBeEnabled('tho_m_060254');
  });
});
