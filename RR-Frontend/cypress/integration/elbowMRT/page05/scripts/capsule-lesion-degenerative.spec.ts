...
context('Page 05 - ElbowMRT', () => {
  ...
  it('Cartilage Lesion Degenerative', () => {
    ...
    clickElement('elb_m_050312', true, 'radio');
    elementShouldBeEnabled('elb_m_050420');
    elementShouldBeEnabled('elb_m_050421');
    elementShouldBeEnabled('elb_m_050422');
    elementShouldBeEnabled('elb_m_050423');
    elementShouldBeEnabled('elb_m_050425');
    elementShouldBeEnabled('elb_m_0504111');
    elementShouldBeEnabled('elb_m_0504114');

    elementShouldBeEnabled('elb_m_050511');
    elementShouldBeEnabled('elb_m_050512');
    elementShouldBeEnabled('elb_m_050513');
  });
});
