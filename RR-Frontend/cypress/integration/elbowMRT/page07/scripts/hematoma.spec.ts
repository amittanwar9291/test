...
context('Page 07 - Soft tissue', () => {
  ...
  describe('Soft tissue', () => {
    it('Soft tissue -> Hematoma', () => {
      ...
      elementShouldBeEnabled('elb_m_0703205');
      elementShouldBeEnabled('elb_m_0703208');

      elementShouldBeEnabled('elb_m_0704202');
      elementShouldBeEnabled('elb_m_0704203');
      elementShouldBeEnabled('elb_m_0704204');
      elementShouldBeEnabled('elb_m_0704205');
