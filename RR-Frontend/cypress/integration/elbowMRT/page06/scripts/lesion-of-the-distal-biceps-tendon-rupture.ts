...
context('Page 06 - Tendons & Muscles - ElbowMRT', () => {
  ...
  it('Lesion of the distal biceps tendon enthesiopathy', () => {
    ...
    elementShouldBeEnabled('elb_m_060212');
    elementShouldBeEnabled('elb_m_060213');

    // Rupture
    clickElement('elb_m_060209', true, 'radio');
    elementShouldBeEnabled('elb_m_060324');
    elementShouldBeEnabled('elb_m_060326');
    elementShouldBeEnabled('elb_m_060333');
    elementShouldBeEnabled('elb_m_060334');

    // Partial tear
    clickElement('elb_m_060324', true, 'radio');
    elementShouldBeEnabled('elb_m_060325');
