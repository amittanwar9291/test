...
context('Page 05 - PelvisMRT', () => {
  ...
  it('Scrotum, infection/inflammation', () => {
    ...
    clickElement('pel_m_050439');
    elementShouldBeEnabled('pel_m_0502102');
    elementShouldBeEnabled('pel_m_0502105');

    clickElement('pel_m_0502102', true, 'radio');
    elementShouldBeEnabled('pel_m_0502103');
    elementShouldBeEnabled('pel_m_0502104');

    elementShouldBeEnabled('pel_m_0502106');
  });
});
