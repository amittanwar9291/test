...
context('Page 12 - Summary', () => {
  ...
  describe('Bones', () => {
    it('Summary -> TN Staging -> Bladder Carcinoma', () => {
      ...
      clickElement('pel_m_120403', true, 'radio');
      elementShouldBeEnabled('pel_m_120513');
      elementShouldBeEnabled('pel_m_120514');
      elementShouldBeEnabled('pel_m_120515');
      elementShouldBeEnabled('pel_m_120516');
      elementShouldBeEnabled('pel_m_120517');

      elementShouldBeEnabled('pel_m_120518');
      elementShouldBeEnabled('pel_m_120519');
      elementShouldBeEnabled('pel_m_120520');
      elementShouldBeEnabled('pel_m_120521');
    });
  });
});
