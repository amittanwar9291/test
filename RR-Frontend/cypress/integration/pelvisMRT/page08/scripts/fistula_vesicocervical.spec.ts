...
context('Page 08 - PelvisMRT', () => {
  ...
  it('Fistula Vesicocervical', () => {
    ...
    // Select Vesicocervical
    selectDropdownOptionOS('pel_m_0802117', 6, true, true);
    ...
    // Select 'Focal wall thickening'
    clickElement('pel_m_0803159', true, 'checkbox');
    elementShouldBeEnabled('pel_m_0803161');
