...
context('Page 02 - PelvisMRT', () => {
  ...
  it('Clinical symptoms: Bloody Stool', () => {
    // Click on Prev. Surgery tab
    clickElement('pel_m_020201');

    // Select Bloody Stool from Clinical Symptoms
    selectDropdownOptionOS('pel_m_020118-1', 8, true, true);
    elementShouldBeEnabled('pel_m_020228');
    clickElement('pel_m_020228', true, 'checkbox');
  });
});
