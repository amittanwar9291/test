...
context('Page 10 - Bones', () => {
  ...
  describe('Bones', () => {
    it('Bones -> Bursitis with CM', () => {
      ...
      elementShouldBeEnabled('pel_m_100440');
      elementShouldBeEnabled('pel_m_100441');
      elementShouldBeEnabled('pel_m_100442');

      clickElement('pel_m_100440', true, 'radio');
      elementShouldBeEnabled('pel_m_100443');
      elementShouldBeEnabled('pel_m_100444');
      elementShouldBeEnabled('pel_m_100445');

      clickElement('pel_m_100441', true, 'radio');
      elementShouldBeEnabled('pel_m_100443');
      elementShouldBeEnabled('pel_m_100444');
      elementShouldBeEnabled('pel_m_100445');
    });
