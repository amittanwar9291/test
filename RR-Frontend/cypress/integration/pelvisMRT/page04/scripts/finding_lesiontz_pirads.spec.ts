...
context('Page 04 - PelvisMRT', () => {
  ...
  it('Lesion TZ PIRADS', () => {
    ...
    selectSliderValueAndCheckIt('pel_m_040238', 0, 1);
    ...
    selectDropdownOptionOS('pel_m_040446', 5, true, true);
    elementShouldBeEnabled('pel_m_040447');
    elementShouldBeEnabled('pel_m_040449');
    // cy.byRRID('pel_m_040536').should('not.be.visible');
    // elementShouldBeDisabled('pel_m_040536');

    selectDropdownOptionOS('pel_m_040449', 3, true, true);
    elementShouldBeEnabled('pel_m_040450');
    elementShouldBeEnabled('pel_m_040538');

    // selectSliderValue('pel_m_040238', 0, 3);
    // clickElement('pel_m_040241', true, 'radio');
    // cy.byRRID('pel_m_040330')
    //   .find('[type="text"]')
    //   .should('have.value', 3);
    // elementShouldBeDisabled('pel_m_040446');

    clickElement('pel_m_040242', true, 'radio');
    cy.byRRID('pel_m_040330')
      .find('[type="text"]')
      .should('have.value', '');
  });
