...
context('Page 04 - PelvisMRT', () => {
  ...
  it('Lesion TZ Char I', () => {
    ...
    elementShouldBeEnabled('pel_m_040224');
    ...
    elementShouldBeEnabled('pel_m_040317');
    elementShouldBeEnabled('pel_m_040318');
    elementShouldBeEnabled('pel_m_040319');
    ...
    elementShouldBeEnabled('pel_m_040430');
    elementShouldBeEnabled('pel_m_040431');

    elementShouldBeEnabled('pel_m_040516');
    elementShouldBeEnabled('pel_m_040521');

    clickElement('pel_m_040224', true);
