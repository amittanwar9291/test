...
context('Page 04 - PelvisMRT', () => {
  ...
  it('Lesion CZ Char I', () => {
    ...
    elementShouldBeEnabled('pel_m_040455');

    elementShouldBeEnabled('pel_m_040233');
    ...
    elementShouldBeEnabled('pel_m_040453');
    elementShouldBeEnabled('pel_m_040453');
    ...
    clickElement('pel_m_040233');
    cy.get('rr-one-cross-section-big.ng-valid')
      .shadowFind('[class="text-normal pointer"]')
      .eq(0)
      .click()
      .should('have.attr', 'class', 'text-normal pointer hovered-text checked-text');
    cy.get('rr-one-cross-section-big.ng-valid')
      .shadowFind('[class="text-normal pointer"]')
      .eq(0)
      .click()
