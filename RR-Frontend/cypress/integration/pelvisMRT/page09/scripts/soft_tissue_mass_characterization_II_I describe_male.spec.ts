...
context('Page 09 - PelvisMRT', () => {
  ...
  it('Soft tissue Characterization II - I describe - Male', () => {
    ...
    elementShouldBeEnabled('pel_m_0904128'); // wrong ID in the code - pel_m_0902174 - should be changed with bugfix 21991
    ...
    // TODO: change ID when the bug is fixed (bug 21991)
    selectDropdownOptionOS('pel_m_0902174', 3, true, true); // pel_m_0904128
    elementShouldBeEnabled('pel_m_0902174');

    // Select option from DD2
    // TODO: change ID when the bug is fixed (bug 21991)
    selectDropdownOptionOS('pel_m_0902174', 3, true, true); // pel_m_0904130
