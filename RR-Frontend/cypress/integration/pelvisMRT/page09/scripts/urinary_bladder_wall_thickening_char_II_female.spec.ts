...
context('Page 09 - PelvisMRT', () => {
  ...
  it('Urinary bladder wall thickening Female Char II', () => {
    ...
    // DD1 - Endometriosis
    selectDropdownOptionOS('pel_m_0904117', 14, true, true);
    elementShouldBeEnabled('pel_m_0904119');

    // DD2 - Infiltrated by uterus/ovarian carcinoma
    selectDropdownOptionOS('pel_m_0904119', 21, true, true);
