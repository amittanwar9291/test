...
context('Page 09 - PelvisMRT', () => {
  ...
  it('Peritoneal nodules', () => {
    ...
    // 2nd column options
    elementShouldBeEnabled('pel_m_090207');
    elementShouldBeEnabled('pel_m_090208');
    elementShouldBeEnabled('pel_m_090209');

    // Select elements
    clickElement('pel_m_090207', true, 'radio');
    clickElement('pel_m_090208', true, 'radio');
    clickElement('pel_m_090209');
  });
});
