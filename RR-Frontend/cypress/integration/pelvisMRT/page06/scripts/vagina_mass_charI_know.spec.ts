...
context('Page 06 - PelvisMRT', () => {
  ...
  it('Vagina mass', () => {
    ...
    selectDropdownOptionOS('pel_m_0603219', 4, true, true);
    clickElement('pel_m_060401');
    elementShouldBeEnabled('pel_m_0602185');

    selectDropdownOptionOS('pel_m_0602185', 2, true, true);
    // TODO: this rr-id is wrong in frontend ..85 (bug nr 22506)
    // elementShouldBeEnabled('pel_m_0602186');
    elementShouldBeEnabled('pel_m_0604209');

    cy.wait(1000);
    selectDropdownOptionOS('pel_m_0602185', 8, true, true);
    elementShouldBeEnabled('pel_m_0604210');

    clickElement('pel_m_0604210', true, 'checkbox');
    elementShouldBeEnabled('pel_m_0604211');
  });
});
