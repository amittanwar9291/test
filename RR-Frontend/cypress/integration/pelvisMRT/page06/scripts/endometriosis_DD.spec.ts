...
context('Page 06 - PelvisMRT', () => {
  ...
  it('Endometriosis', () => {
    ...
    elementShouldBeEnabled('pel_m_0602460');
    elementShouldBeEnabled('pel_m_0603491');

    selectDropdownOptionOS('pel_m_0602460', 3, true, true);
    elementShouldBeEnabled('pel_m_0602461');

    selectDropdownOptionOS('pel_m_0602461', 4, true, true);
