...
context('Page 04 - FeetMRT', () => {
  ...
  it('Fracture Os cuneiforme intermedium', () => {
    ...
    elementShouldBeEnabled('anc_m_040343');
    elementShouldBeEnabled('anc_m_0403221');

    clickElement('anc_m_040343', true, 'radio');
    elementShouldBeEnabled('anc_m_0404308');
    elementShouldBeEnabled('anc_m_0404309');
    elementShouldBeEnabled('anc_m_0404310');
