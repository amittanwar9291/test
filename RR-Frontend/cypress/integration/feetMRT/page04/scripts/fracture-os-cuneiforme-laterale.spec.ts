...
context('Page 04 - FeetMRT', () => {
  ...
  it('Fracture Os cuneiforme laterale', () => {
    ...
    elementShouldBeEnabled('anc_m_040344');
    elementShouldBeEnabled('anc_m_0403221');

    clickElement('anc_m_040344', true, 'radio');
    elementShouldBeEnabled('anc_m_0404311');
    elementShouldBeEnabled('anc_m_0404312');
    elementShouldBeEnabled('anc_m_0404313');
