...
context('Page 04 - FeetMRT', () => {
  ...
  it('Fracture Distal fibula', () => {
    ...
    elementShouldBeEnabled('anc_m_040316');
    elementShouldBeEnabled('anc_m_040317');
    elementShouldBeEnabled('anc_m_040318');

    clickElement('anc_m_040318', true, 'radio');
    elementShouldBeEnabled('anc_m_040319');
    elementShouldBeEnabled('anc_m_040320');
  });
});
