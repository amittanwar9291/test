...
context('Page 05 - FeetMRT', () => {
  ...
  it('Tendinopathy-Tendon of the posterior tibialis muscle-Tear', () => {
    ...
    clickElement('anc_m_050253', true, 'checkbox');

    elementShouldBeEnabled('anc_m_0504100');
    elementShouldBeEnabled('anc_m_0504101');

    clickElement('anc_m_0504100', true, 'radio');
    elementShouldBeEnabled('anc_m_0504103');
    elementShouldBeEnabled('anc_m_0504105');
    elementShouldBeEnabled('anc_m_0504108');
    elementShouldBeEnabled('anc_m_050548');
    elementShouldBeEnabled('anc_m_050549');
    elementShouldBeEnabled('anc_m_050550');
  });
});
