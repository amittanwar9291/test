...
context('Page 05 - FeetMRT', () => {
  ...
  it('Tendinopathy-Tendon of the anterior tibialis muscle-Tendinopathy', () => {
    ...
    clickElement('anc_m_050243', true, 'checkbox');

    elementShouldBeEnabled('anc_m_050359');
    elementShouldBeEnabled('anc_m_050360');
    elementShouldBeEnabled('anc_m_050361');
    elementShouldBeEnabled('anc_m_050362');
    elementShouldBeEnabled('anc_m_050363');
    elementShouldBeEnabled('anc_m_050364');
    elementShouldBeEnabled('anc_m_050365');
    elementShouldBeEnabled('anc_m_050366');
    elementShouldBeEnabled('anc_m_050367');
    elementShouldBeEnabled('anc_m_050368');
  });
});
