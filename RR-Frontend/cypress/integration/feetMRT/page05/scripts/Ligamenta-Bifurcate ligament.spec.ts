...
context('Page 05 - FeetMRT', () => {
  ...
  it('Ligamenta-Ankle joint', () => {
    ...
    clickElement('anc_m_050206', true, 'radio');

    elementShouldBeEnabled('anc_m_050317');
    elementShouldBeEnabled('anc_m_050318');
    elementShouldBeEnabled('anc_m_050319');
    clickElement('anc_m_050319', true, 'checkbox');
    elementShouldBeEnabled('anc_m_050320');
  });
});
