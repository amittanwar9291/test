...
context('Page 05 - FeetMRT', () => {
  ...
  it('Tendinopathy-Tendon of M. flexor hallucis longus-Tear', () => {
    ...
    clickElement('anc_m_050250', true, 'checkbox');

    elementShouldBeEnabled('anc_m_050530');
    elementShouldBeEnabled('anc_m_050531');
    elementShouldBeEnabled('anc_m_050536');
    elementShouldBeEnabled('anc_m_050537');
    elementShouldBeEnabled('anc_m_050539');
    elementShouldBeEnabled('anc_m_050540');
  });
});
