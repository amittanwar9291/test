...
context('Page 09 -> Pericardium Vessels', () => {
  ...
  describe('Mass', () => {
    it('Mass -> Differential diagnosis', () => {
      clickElement('car_m_090106', true, 'radio');
      elementShouldBeEnabled('car_m_090107-1');
      findingColumn.selectFindingOptionByAppearance(3);
      cy.byRRID('car_m_090333').click();
      selectFindingsDropdownOption('car_m_0902174', '.ui-dropdown-label', 1, true, true);
      elementShouldBeEnabled('car_m_0902175');
      elementShouldBeEnabled('car_m_0902177');
      selectFindingsDropdownOption('car_m_0902177', '.ui-dropdown-label', 1, true, true);
      elementShouldBeEnabled('car_m_0902178');
    });
  });
});
