...
context('Page 04 - Flaps', () => {
  ...
  it('Congential heart disease - Ventricle septal defect (VSD)', () => {
    ...
    elementShouldBeEnabled('car_m_040345');
    elementShouldBeEnabled('car_m_040346');
    elementShouldBeEnabled('car_m_040347');
    elementShouldBeEnabled('car_m_040348');

    elementShouldBeEnabled('car_m_040435');
    elementShouldBeEnabled('car_m_040438');
