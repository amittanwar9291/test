...
context('Cardio page03 - Contrast Enchanced', () => {
  ...
  describe('Sequences', () => {
    it('Individually without CM -> Yes', () => {
      ...
      elementShouldBeEnabled('car_m_030502');
      elementShouldBeEnabled('car_m_030503');
      elementShouldBeEnabled('car_m_030504');

      elementShouldBeEnabled('uni_y_030502');
      elementShouldBeEnabled('uni_x_030525');
      ...
      clickElement('uni_x_030419', true, 'checkbox');
