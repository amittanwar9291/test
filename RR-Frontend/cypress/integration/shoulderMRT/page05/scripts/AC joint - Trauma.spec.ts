...
context('Shoulder Page 05 - AC-Joint & Rotator Cuff', () => {
  ...
  describe('AC joint - trauma', () => {
    it('AC joint', () => {
      ...
      clickElement('sho_m_050204', true, 'radio');
      elementShouldBeEnabled('sho_m_050401');
      elementShouldBeEnabled('sho_m_050406');

      clickElement('sho_m_050401', true, 'radio');
      elementShouldBeEnabled('sho_m_050403');
      elementShouldBeEnabled('sho_m_050404');
      elementShouldBeEnabled('sho_m_050405');

      clickElement('sho_m_050406', true, 'radio');
      elementShouldBeEnabled('sho_m_050408');
      elementShouldBeEnabled('sho_m_050409');
      elementShouldBeEnabled('sho_m_050410');
      elementShouldBeEnabled('sho_m_050411');
      elementShouldBeEnabled('sho_m_050412');
      elementShouldBeEnabled('sho_m_050413');
    });
  });
});
