...
context('Shoulder Page 05 - AC-Joint & Rotator Cuff', () => {
  ...
  describe('AC joint - Degeneration', () => {
    it('AC joint', () => {
      ...
      clickElement('sho_m_050202', true, 'radio');

      elementShouldBeEnabled('sho_m_050301');
      elementShouldBeEnabled('sho_m_050302');
      elementShouldBeEnabled('sho_m_050303');
      elementShouldBeEnabled('sho_m_050304');
      elementShouldBeEnabled('sho_m_050305');
      elementShouldBeEnabled('sho_m_050306');
      elementShouldBeEnabled('sho_m_050307');

      clickElement('sho_m_050307', true, 'checkbox');
      elementShouldBeEnabled('sho_m_050308');
      elementShouldBeEnabled('sho_m_050309');
    });
  });
});
