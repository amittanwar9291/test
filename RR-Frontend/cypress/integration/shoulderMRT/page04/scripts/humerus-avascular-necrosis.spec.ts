...
context('ShoulderMRT - Page 04 - Bones', () => {
  ...
  it('Humerus, avascular necrosis (AVN)', () => {
    clickElement('sho_m_040105');
    findingColumn.selectFindingOptionByAppearance(3);
    const enabledElements1 = ['sho_m_040107', 'sho_m_040219', 'sho_m_040221', 'uni_04_003', 'uni_04_005', 'uni_04_007'];
    elementShouldBeEnabled(enabledElements1);

    clickElement('sho_m_040219');
    elementShouldBeEnabled('sho_m_040219');
  });
});
