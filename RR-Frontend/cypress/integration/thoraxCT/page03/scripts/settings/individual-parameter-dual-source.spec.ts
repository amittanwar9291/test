...
context('ThoraxCT page03 - Individual Parameter Dual Source', () => {
  ...
  describe('ThoraxCT Technology', () => {
    it('Individual Parameter Dual Source', () => {
      ...
      findingColumn.selectFindingOptionByAppearance(2);
      selectDropdownOption('uni_xc_030303', 2);
      cy.byRRID('uni_xc_030305').type('111');
      cy.byRRID('uni_xc_030308').type('11');
      cy.byRRID('uni_xc_030311').type('111');
      cy.byRRID('uni_xc_030313').type('111');
      cy.byRRID('uni_xc_030316').type('111');
      cy.byRRID('uni_xc_030318').type('111');
