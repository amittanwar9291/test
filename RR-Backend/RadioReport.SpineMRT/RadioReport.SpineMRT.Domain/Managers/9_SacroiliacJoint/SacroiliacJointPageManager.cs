...
{
    public class SacroiliacJointPageManager : PageManagerBase<SacroiliacJointPage, ISacroiliacJointPageRepository>
    {
        public override string PageTypeName => PageTypeNames.SpineMrtSacroiliacJoint;
