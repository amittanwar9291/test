...
using RadioReport.ShoulderMRT.Domain.Services;
using Xunit;

namespace RadioReport.Tests.Modules.ShoulderMRT
{
    public class ShoulderMrtImportReportServiceTests
    {
        private readonly ShoulderMRTImportReportService _classUnderTest;
        ...
        public ShoulderMrtImportReportServiceTests()
        {
            var fakeLogger = A.Fake<ILogger<ShoulderMRTImportReportService>>();
            ...
            _classUnderTest = new ShoulderMRTImportReportService(fakeLogger, _kafkaProducerFake, _moduleContextFake, _dicomValueParserFake,
                _httpAuthContextFake,
        ...
        public async void ImportReport_ValuesImportable_ValuesImportedProperly()
        {
            ...
            {
                new PageInfo { TypeName = PageTypeNames.ShoulderMrtLocalization },
                new PageInfo { TypeName = PageTypeNames.ShoulderMrtTechnology }
            };
            ...
            A.CallTo(() => _moduleContextFake.LocalizationPageName).Returns(PageTypeNames.ShoulderMrtLocalization);
            A.CallTo(() => _moduleContextFake.TechnologyPageName).Returns(PageTypeNames.ShoulderMrtTechnology);
            A.CallTo(() => _moduleContextFake.TotalPageCount).Returns((byte) 2);
            A.CallTo(() => _moduleContextFake.Type).Returns(ModuleType.ShoulderMRT);
            ...
            Assert.Equal(ModuleType.ShoulderMRT.GetReportTypeName(), result.ExaminationType);
