...
{
    [GeneratedControllerPageModel("ElbowMRT/Technology")]
    public class TechnologyPage : TechnologyMRTPageBase<CMSideEffect, Sequence, TechnologyPage>
    {
        ...
        #region Sequence
        [RadioReportId("elb_m_030101")]
        public bool IsFABSPosition { get; set; }
        ...
        public override string PageTypeName => Common.Module.Logic.Consts.PageTypeNames.ElbowMrtTechnology;
