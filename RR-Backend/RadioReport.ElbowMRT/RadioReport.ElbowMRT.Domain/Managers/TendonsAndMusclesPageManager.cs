...
{
    public class TendonsAndMusclesPageManager : PageManagerBase<TendonsAndMusclesPage, ITendonsAndMusclesPageRepository>
    {
        public override string PageTypeName => PageTypeNames.ElbowMrtTendonsAndMuscles;

        protected override List<Type> FindingTypes => new List<Type> { typeof(TendonsAndMusclesFindingType) };

        public TendonsAndMusclesPageManager(ITendonsAndMusclesPageRepository repository,
