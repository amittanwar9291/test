...
namespace RadioReport.AbdomenCT.Repo.Repositories
{
    ...
    {
        public SpleenPageRepository(AbdomenCTDbContext dbContext, IMinIOWrapper minIOWrapper, ILogger<SpleenPageRepository> logger)
            : base(dbContext, minIOWrapper, nameof(AbdomenCT), logger)
        {
        }
