...
{
    public class AngiographyMRTImportReportService : ImportReportService
    {
        ...
        public AngiographyMRTImportReportService(
            ILogger<AngiographyMRTImportReportService> logger,
