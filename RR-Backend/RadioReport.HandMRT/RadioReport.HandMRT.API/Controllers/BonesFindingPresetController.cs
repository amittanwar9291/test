...
{
    [ApiVersion( "1.0" )]
    [Route("api/HandMRT/Bones/Presets")]
    [ApiController]
    public class BonesFindingPresetController : ApiControllerBase<IBonesFindingPresetManager, BonesFindingPreset>
    {
        ...
        public async Task<ActionResult<BonesFindingPreset>> GetByDiagnosis(TumorDifferentialDiagnosisType diagnosis, Guid reportId) => 
