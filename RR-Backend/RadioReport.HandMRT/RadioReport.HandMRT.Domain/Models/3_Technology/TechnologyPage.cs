...
{
    [GeneratedControllerPageModel("HandMRT/Technology")]
    public class TechnologyPage : TechnologyMRTPageBase<CMSideEffect, Sequence, TechnologyPage>
    {
        ...
        [RadioReportId("han_m_030202")]
        public ApplicationLocalizationType ApplicationLocalizationType { get; set; }
        #endregion
        ...
        public override string PageTypeName => Common.Module.Logic.Consts.PageTypeNames.HandMrtTechnology;
    }
}
