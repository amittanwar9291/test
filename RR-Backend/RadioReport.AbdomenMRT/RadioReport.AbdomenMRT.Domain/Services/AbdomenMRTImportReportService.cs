...
{
    public class AbdomenMRTImportReportService : ImportReportService
    {
        private readonly IPageManager<ExaminationRegionPage> _examinationRegionPageManager;
        private readonly IPageManager<TechnologyPage> _technologyPageManager;

        public AbdomenMRTImportReportService(
            ILogger<AbdomenMRTImportReportService> logger,
            IKafkaProducer kafkaProducer,
            ModuleContext moduleContext,
            IDicomValueParser dicomValueParser,
            HttpAuthContext httpAuthContext,
            IPageManager<ExaminationRegionPage> examinationRegionPageManager,
        ...
        {
            _examinationRegionPageManager = examinationRegionPageManager;
        ...
        protected override async Task<Guid> CreateLocalizationPageAndImport(ICollection<StringImportValue> importValues, PatientInformation patientInformation,
            Guid reportId)
        {
            var examinationRegionPage = new ExaminationRegionPage
            {
                ReportId = reportId,
                PatientInformation = patientInformation
            };
            SetDicomValues(importValues, examinationRegionPage);
            examinationRegionPage = await _examinationRegionPageManager.AddAsync(examinationRegionPage);

            return examinationRegionPage.Id;
        }
